            ...
            <div className="secContent container">
                ...
                <div className="footerCard flex">
                    <div className="footerIntro flex">
                        ...
                        Vacations are meant to make memories! And a well-planned itinerary makes for the vacation of a lifetime. Choose from a variety of destinations including picturesque mountains, vibrant valleys, majestic monuments, gorgeous cities and adventurous trails. Holidays to these exclusive destinations are available at a preferred budget, ranging from Rs. 10,000 to 50,000, including both pocket-friendly as well as uber-luxurious options. 
                        </div>
                    ...
                    <div className="footerDiv flex">
                        ...
                        <small>COPYRIGHTS LATHASRI 2024</small>
                    </div>
                </div>
            </div>
        </section>
